    ...
    >
      ...
      <div className="w-full max-w-md px-6 flex flex-col gap-8 mt-20 z-10">
        ...
        <section className="bg-white border-4 border-black p-8 shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] flex flex-col items-center text-center relative">
          ...
          <h1 className="font-bold text-sm text-neutral-900 mb-1 tracking-tight w-full text-center whitespace-nowrap">
          ...
          <div className="flex justify-center gap-6">
            ...
            <a href={`https://tiktok.com/@madmonkey${property.handle}`} target="_blank" rel="noopener noreferrer" className="p-4 bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:scale-110 transition-all rounded-full" aria-label="TikTok">
              <svg className="w-6 h-6 fill-black" viewBox="0 0 24 24"><path d="M12.525.02c1.31-.032 2.612-.019 3.91-.01 0 1.161.127 2.305.457 3.41 1.053.045 2.112.28 3.125.617v4.06c-1.076-.23-2.184-.337-3.284-.316-.017 1.32-.01 2.64-.01 3.96 0 2.264.12 4.55-.49 6.74-.636 2.503-2.316 4.7-4.63 5.86-3.08 1.63-7.144 1.265-9.84-1.012-2.82-2.36-3.665-6.66-1.92-9.98 1.576-2.924 5.09-4.81 8.39-4.14v4.11c-1.365-.436-2.99-.21-4.14.65-1.505 1.09-2.006 3.25-1.12 4.965.75 1.455 2.35 2.32 3.945 2.224 1.833-.105 3.32-1.63 3.37-3.46v-14.8zm0 0"/></svg>
            </a>
          </div>
        </section>
        ...
        <section className="flex flex-col gap-4">
          ...
          <a href="https://madmonkeyhostels.com/check-in" className="w-full py-5 px-8 bg-yellow-400 border-4 border-black flex items-center justify-between font-medium text-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all uppercase tracking-tight text-lg">
            <span>Skip the Queue: Check-in Online</span>
          ...
          <a href={`https://madmonkeyhostels.com/esim${utmSuffix}`} className="w-full py-5 px-8 bg-blue-500 border-4 border-black flex items-center justify-between font-medium text-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all uppercase tracking-tight text-lg">
        ...
        <footer className="mt-12 mb-8 flex flex-col items-center gap-8">
          ...
          <div className="flex gap-14">
            ...
            <a href="https://tiktok.com/@madmonkeyhostels" className="hover:scale-125 transition-all filter drop-shadow-md" aria-label="TikTok">
              <svg className="w-9 h-9 fill-black" viewBox="0 0 24 24"><path d="M12.525.02c1.31-.032 2.612-.019 3.91-.01 0 1.161.127 2.305.457 3.41 1.053.045 2.112.28 3.125.617v4.06c-1.076-.23-2.184-.337-3.284-.316-.017 1.32-.01 2.64-.01 3.96 0 2.264.12 4.55-.49 6.74-.636 2.503-2.316 4.7-4.63 5.86-3.08 1.63-7.144 1.265-9.84-1.012-2.82-2.36-3.665-6.66-1.92-9.98 1.576-2.924 5.09-4.81 8.39-4.14v4.11c-1.365-.436-2.99-.21-4.14.65-1.505 1.09-2.006 3.25-1.12 4.965.75 1.455 2.35 2.32 3.945 2.224 1.833-.105 3.32-1.63 3.37-3.46v-14.8zm0 0"/></svg>
            </a>
          </div>
